...
class PunctuationProcessor
{
    ...
    {
        // Single quotes
        $text = preg_replace(self::SMART_SINGLE_QUOTES_REGEX, "'", $text) ?? $text;

        // Double quotes
        $text = preg_replace(self::SMART_DOUBLE_QUOTES_REGEX, '"', $text) ?? $text;
    ...
    {
        return preg_replace(self::UNICODE_DASHES_REGEX, '-', $text) ?? $text;
    }
    ...
    {
        return preg_replace(self::ELLIPSIS_REGEX, '...', $text) ?? $text;
    }
    ...
    {
        return preg_replace(self::BULLETS_REGEX, '*', $text) ?? $text;
    }
