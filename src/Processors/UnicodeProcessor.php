...
class UnicodeProcessor
{
     ...
     */
    private const INVISIBLE_CHARS_REGEX = '/[\x{00A0}\x{2000}-\x{200D}\x{202F}\x{2060}\x{3000}\x{FEFF}\x{200E}\x{200F}\x{202A}-\x{202E}]+/u';
    ...
    {
        return preg_replace(self::INVISIBLE_CHARS_REGEX, '', $text);
    }
    ...
    {
        return preg_replace(self::CONTROL_CHARS_REGEX, '', $text);
    }
    ...
    {
        return preg_replace(self::SOFT_HYPHEN_REGEX, '', $text);
    }
}